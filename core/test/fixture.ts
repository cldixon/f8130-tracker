 ...
 * — with the sockets removed. Every adversarial case the demonstration cares
 * about (forgery, tampering, a stitched chain, a rotated key) is reproducible
 * here deterministically, which is worth considerably more than pointing the
 * tests at one live server and hoping it misbehaves on cue.
 */
...
import { commitForm } from '../src/commitment.js'
import { PUBLIC_FIELDS, type RawForm } from '../src/fields.js'
import type {
  IdentityResolver,
  RecordLocation,
  RepoClient,
  ResolvedIdentity,
  SigningKey,
} from '../src/verify/ports.js'
import { RepoFetchError } from '../src/verify/ports.js'
...
export class FakeNetwork implements IdentityResolver, RepoClient {
